...
public class ElectricSpawner extends SimpleSlimefunItem<BlockTicker> implements EnergyNetComponent {
    ...
    public ElectricSpawner(Category category, String mob, EntityType type, Research research) {
        super(category, new SlimefunItemStack("ELECTRIC_SPAWNER_" + mob, "db6bd9727abb55d5415265789d4f2984781a343c68dcaf57f554a5e9aa1cd", "&e電力刷怪籠 &7(" + StringUtils.format(mob)
                + ")", "", "&8\u21E8 &e\u26A1 &7最高實體限制: 6", "&8\u21E8 &e\u26A1 &7512 J 緩衝", "&8\u21E8 &e\u26A1 &7240 J/怪物"), RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] { null, SlimefunItems.PLUTONIUM, null, SlimefunItems.ELECTRIC_MOTOR, new CustomItem(Material.SPAWNER, "&b強化刷怪籠", "&7Type: &b" + StringUtils.format(type.toString())), SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.BLISTERING_INGOT_3, SlimefunItems.LARGE_CAPACITOR, SlimefunItems.BLISTERING_INGOT_3 });

        this.entity = type;

        addItemHandler(onBlockPlace());

        new BlockMenuPreset(getID(), "&c電力刷怪籠") {
            ...
            public void newInstance(BlockMenu menu, Block b) {
                if (!BlockStorage.hasBlockInfo(b) || BlockStorage.getLocationInfo(b.getLocation(), "enabled") == null || BlockStorage.getLocationInfo(b.getLocation(), "enabled").equals("false")) {
                    menu.replaceExistingItem(4, new CustomItem(Material.GUNPOWDER, "&7狀態: &4\u2718", "", "&e> 點擊啟動"));
                    ...
                    menu.replaceExistingItem(4, new CustomItem(Material.REDSTONE, "&7狀態: &2\u2714", "", "&e> 點擊停用"));
                    menu.addMenuClickHandler(4, (p, slot, item, action) -> {
