...
public class ElectricSpawners extends JavaPlugin implements Listener, SlimefunAddon {
    ...
    public void onEnable() {
        ...
        Category category = new Category(new NamespacedKey(this, "electric_spawners"), new CustomItem(SkullItem.fromHash("db6bd9727abb55d5415265789d4f2984781a343c68dcaf57f554a5e9aa1cd"), "&9電力刷怪籠"));
        Research research = new Research(new NamespacedKey(this, "electric_spawners"), 4820, "電能刷怪籠", 30);
